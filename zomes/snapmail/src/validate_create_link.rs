...
// #[hdk_extern]
// fn validate_create_link(submission: ValidateCreateLinkData)
...
) -> ExternResult<ValidateLinkCallbackResult>
{
   ...
   return LinkKind::validate_create(candidat);
}
...
//     debug!("*** validate_create_link() called! {:?} \n -- tag = {}",
//            candidat.link_add, tag_str).ok();
//
//    // /// Check for Handle
...
//
//    /// Check Members
//    if candidat.link_add.tag == LinkKind::Members.as_tag() {
//       // FIXME
//       return Ok(ValidateLinkCallbackResult::Valid);
//    }
//
//    /// Check Acknolwedgment
//    if candidat.link_add.tag == LinkKind::Acknowledgment.as_tag() {
//       // TODO: check from InMail and unicity
//       return Ok(ValidateLinkCallbackResult::Valid);
//    }
//
//    /// Check Pending
//    if candidat.link_add.tag == LinkKind::Pending.as_tag() {
//       // TODO
//       return Ok(ValidateLinkCallbackResult::Valid);
//    }
//
//    /// Check Receipt
//    let maybe_hash: ExternResult<AgentPubKey> = LinkKind::Receipt.unconcat_hash(&candidat.link_add.tag);
...
//
//    /// Check AckInbox
//    let maybe_hash: ExternResult<AgentPubKey> = LinkKind::AckInbox.unconcat_hash(&candidat.link_add.tag);
//    if let Ok(_from) = maybe_hash {
//       // TODO
//       return Ok(ValidateLinkCallbackResult::Valid);
//    }
//
//    /// Check MailInbox
//    let maybe_hash: ExternResult<AgentPubKey> = LinkKind::MailInbox.unconcat_hash(&candidat.link_add.tag);
//    if let Ok(_from) = maybe_hash {
//       // TODO
//       return Ok(ValidateLinkCallbackResult::Valid);
//    }
//
//    /// Check Pendings
//    let maybe_hash: ExternResult<AgentPubKey> = LinkKind::Pendings.unconcat_hash(&candidat.link_add.tag);
//    if let Ok(_from) = maybe_hash {
//       // TODO
//       return Ok(ValidateLinkCallbackResult::Valid);
//    }
...
//
//    /// Done
//    debug!("*** validate_create_link() DONE").ok();
